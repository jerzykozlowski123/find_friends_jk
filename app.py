...
st.set_page_config(page_title="Find Friends", menu_items={'About': 'Find Friends by JK with Od_Zera_Do_AI'})
...
with st.sidebar:
    ...
    fav_animals = st.selectbox("Ulubione zwierzęta", ["Wybierz", 'Brak ulubionych', 'Psy', 'Koty', 'Koty i Psy', 'Inne'])
